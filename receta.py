...
def generar_receta_html(pauta: Dict, observaciones: str = "", producto_recetado: str = "") -> str:
    ...
    dosis_por_envase = int(volumen_envase / ml_por_toma) if ml_por_toma > 0 else 0
    
    # Obtener la patología
    patologia = pauta.get('patologia', 'No especificada')
        ...
        <div class="receta">
            ...
            <div class="seccion">
                ...
                <div class="seccion-contenido">
                    ...
                    &nbsp;&nbsp;|&nbsp;&nbsp;
                    <strong>Edad:</strong> {pauta.get('edad', '_____')}
                    &nbsp;&nbsp;|&nbsp;&nbsp;
                    <strong>Patología:</strong> {patologia}
                </div>
            </div>
            ...
            <div class="seccion">
                ...
                <div class="seccion-contenido">
                    ...
                    <div class="info-extra">
                        ...
                        <span>Envase: {volumen_envase} mL • {dosis_por_envase} dosis por envase</span>
                    </div>
                </div>
            </div>
            ...
            <div class="footer-receta">
                Documento generado por GreenMed Pro v2.0 - {datetime.now().strftime("%d/%m/%Y %H:%M")}
            </div>
        </div>
    </body>
    </html>
