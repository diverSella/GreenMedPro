    ...
    def __init__(self):
        self.productos: Dict[str, Producto] = {
            "Xpectra 10": Producto(
                ...
                descripcion="CBD al 10% en base a Extracto de Espectro Completo - Administración con gotero"
            ),
            "Xatiplex 5": Producto(
                nombre="Xatiplex 5",
                concentracion=5.0,
                ...
                gotas_por_ml=None,
                volumenes_disponibles=[10, 30],
                descripcion="CBD al 5% en base a CBD purificado - Administración con jeringa"
            ),
            "Xatiplex 10": Producto(
                ...
                gotas_por_ml=None,
                volumenes_disponibles=[10, 30],
                descripcion="CBD al 10% en base a CBD purificado - Administración con jeringa"
            ),
            "Xatiplex 15": Producto(
                ...
                gotas_por_ml=None,
                volumenes_disponibles=[10, 30],
                descripcion="CBD al 15% en base a CBD purificado - Administración con jeringa"
            ),
            "Xatiplex 20": Producto(
                ...
                gotas_por_ml=None,
                volumenes_disponibles=[10, 30],
                descripcion="CBD al 20% en base a CBD purificado - Administración con jeringa"
            )
        }
